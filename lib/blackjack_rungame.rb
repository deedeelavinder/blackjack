...
class Hand
  ...
  def initial_deal
    # print "initial deal"
    print @deck_o_cards.deck.pop
    # 2.times {@p_hand << @deck_o_cards.pop}
    # 2.times {@d_hand << @deck_o_cards.pop}
  end
end
  ...
  def hit_or_stand
    loop do
      ...
      if answer == "h" || answer == "hit"
        @p_hand << @deck_o_cards.deck.shuffle.pop
        sum_p_hand
  ...
  def d_finish
    loop do
      ...
      if @d_hand_sum < 17
        ...
        @d_hand << @deck_o_cards.deck.shuffle.pop
        sum_d_hand
      elsif @d_hand_sum >= 17
        puts "My hand equals #{@d_hand_sum}."
        win_or_lose
